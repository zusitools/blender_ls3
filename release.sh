...
mkdir io_scene_ls3
cp -r README.md batchexport_settings.xml __init__.py lsb.py ls3_export.py ls3_import.py ls_import.py zusiconfig.py.default zusiprops.py zusi_material_wrapper.py i18n.py l10n io_scene_ls3
